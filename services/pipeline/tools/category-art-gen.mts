...
const SUBJECT: Record<string, string> = {
  ...
  communication: 'A desk phone on a site-office desk, handset in its cradle, coiled cord, screen dark.',
  furniture: 'A site-office desk with an ergonomic chair and a stacking visitor chair.',
