/* ═══════════════════════════════════════════════════════════════════════════════
   ...
   Every export name is IDENTICAL to the old file, and so is the props contract.
   Swapping the two files is the entire migration; nothing that imports an icon
   changes. Do the swap in one commit and delete the lucide-react dependency.
...
const BOX = 'M3.5 4h11.9L20.5 9.1V20H3.5z'; //  chamfered container, top-right cut
const BOX_SM = 'M6 7h7.6L18 11.4V18H6z'; //  the same shape one step in

export const ICON_CHAMFER = 4.6;
