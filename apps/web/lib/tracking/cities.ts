...
export const CITIES: Record<string, City> = {
  hyd: {
    id: 'hyd',
    name: 'Hyderabad',
    yard: { name: 'Kondapur yard', address: 'Botanical Garden Road, Kondapur, Hyderabad 500084', lat: 17.4634, lng: 78.3618 },
    drop: { name: 'Madhapur', address: 'Road No. 12, Ayyappa Society, Madhapur, Hyderabad 500081', lat: 17.4504, lng: 78.3808 },
    partnerAt: { lat: 17.47, lng: 78.365 },
  ...
  tpt: {
    id: 'tpt',
    name: 'Tirupati',
    yard: { name: 'Renigunta Road yard', address: 'Renigunta Road, near Karakambadi crossing, Tirupati 517507', lat: 13.639, lng: 79.446 },
    drop: { name: 'Tilak Road', address: 'Tilak Road, Tirupati 517501', lat: 13.631, lng: 79.418 },
    partnerAt: { lat: 13.6335, lng: 79.4395 },
  ...
  vij: {
    id: 'vij',
    name: 'Vijayawada',
    yard: { name: 'Auto Nagar yard', address: 'Auto Nagar, Vijayawada 520007', lat: 16.495, lng: 80.679 },
    drop: { name: 'Benz Circle', address: 'MG Road, near Benz Circle, Vijayawada 520010', lat: 16.4975, lng: 80.656 },
    partnerAt: { lat: 16.489, lng: 80.669 },
  ...
  vizag: {
    id: 'vizag',
    name: 'Visakhapatnam',
    yard: { name: 'Marripalem yard', address: 'NH16 service road, Marripalem, Visakhapatnam 530018', lat: 17.744, lng: 83.256 },
    drop: { name: 'Dwaraka Nagar', address: 'Dwaraka Nagar, Visakhapatnam 530016', lat: 17.729, lng: 83.304 },
    partnerAt: { lat: 17.743, lng: 83.266 },
